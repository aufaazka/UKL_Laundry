...
if($_POST){
    ...
    if(empty($nama)){
        ...
        include "koneksi.php";
            ...
            if($update){
                echo "<script>alert('Sukses update data admin');location.href='tampil_user.php';</script>";
            } else {
                echo "<script>alert('Gagal update data admin');location.href='ubah_user.php?id_user".$id_user."';</script>";
            }
